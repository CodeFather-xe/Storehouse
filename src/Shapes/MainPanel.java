...
//    add(makeTitledPanel("JSlider + JLayer", new JLayer<>(slider2, new ToggleSwitchLayerUI())));
    ...
    // To Create Title Border For the Switch
...
//      return;
//    }
//    JFrame frame = new JFrame("Shapes.ToggleSwitch");
...
//    static class ToggleSwitchLayerUI extends LayerUI<JSlider> {
//        @Override
...
//
//        @Override
//        protected void processMouseEvent(MouseEvent e, JLayer<? extends JSlider> l) {
...
//
//        @Override
//        protected void processMouseMotionEvent(MouseEvent e, JLayer<? extends JSlider> l) {
//            l.getView().repaint();
//        }
//    }
}